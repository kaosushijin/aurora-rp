...
class StoryMomentumEngine:
    ...
    def __init__(self, debug_logger=None, orchestrator_callback=None):
        ...
        self._resolution_guidance_sent = False  # Track if we've sent resolution guidance
...
# Chunk 3/3 - sme.py - State Management Interface and Utilities
    ...
    def check_resolution_trigger(self) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if (self.pressure_level >= 1.0 and
                ...
                resolution_data = {
                    ...
                    "pressure_level": self.pressure_level,
                    "story_arc": self.story_arc.value,
                    "guidance_prompt": self._generate_resolution_prompt(),
            ...
            # Also check for extended combat without resolution
                ...
                resolution_data = {
                    ...
                    "pressure_level": self.pressure_level,
                    "story_arc": self.story_arc.value,
                    "guidance_prompt": self._generate_extended_combat_prompt(),
...
2. ESCAPE: Strategic withdrawal, threat temporarily avoided
3. DEFEAT: Setback requiring recovery, but not character death
